...
# Train the model
print("\nTraining VGG16 model with 10 epochs...")
...
plt.tight_layout()
plt.savefig('vgg_training_history.png', dpi=300, bbox_inches='tight')
print("\nTraining history graph saved as 'vgg_training_history.png'")
...
plt.title('Confusion Matrix - VGG16', fontsize=14, fontweight='bold')
plt.ylabel('True Label', fontsize=12)
plt.xlabel('Predicted Label', fontsize=12)
plt.tight_layout()
plt.savefig('vgg_confusion_matrix.png', dpi=300, bbox_inches='tight')
print("Confusion matrix saved as 'vgg_confusion_matrix.png'")
...
plt.tight_layout()
plt.savefig('vgg_sample_predictions.png', dpi=300, bbox_inches='tight')
print("Sample predictions visualization saved as 'vgg_sample_predictions.png'")
