...
print("Loading trained MobileNet model...")
...
fig.suptitle('Sample Predictions from Test Data - MobileNetV3Large', fontsize=16, fontweight='bold')
...
print("✓ Sample predictions saved as 'mobilenet_sample_predictions.png'")
